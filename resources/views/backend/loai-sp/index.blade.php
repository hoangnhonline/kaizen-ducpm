          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td>                  
                  <a href="{{ route( 'loai-sp.edit', [ 'id' => $item->id ]) }}">{{ $item->name_vi }}</a>                                 
                ...
                <a class="btn btn-default btn-sm" href="{{ route('danh-muc-cha', $item->slug_vi ) }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
                  ...
                  <a onclick="return callDelete('{{ $item->name_vi }}','{{ route( 'loai-sp.destroy', [ 'id' => $item->id ]) }}');" class="btn-sm btn btn-danger">Xóa</a>
                  @endif
                </td>
              </tr> 
              @endforeach
